import {
  CommonModule
} from "./chunk-BDZDX26N.js";
import "./chunk-76H2ZGKI.js";
import {
  AsyncSubject,
  BehaviorSubject,
  Directive,
    ...
    return new Promise((resolve, reject) => {
      try {
        this.loadScript(_GoogleLoginProvider.PROVIDER_ID, this.getGoogleLoginScriptSrc(lang || ""), () => {
          ...
          reject(`There was an issue loading the ${_GoogleLoginProvider.PROVIDER_ID} authentication script.`);
        });
      } catch (err) {
        reject(err);
      } finally {
...
var SOCIAL_AUTH_CONFIG = new InjectionToken("SocialAuthServiceConfig");
var SocialAuthService = class _SocialAuthService {
  ...
  static {
    this.ɵfac = function SocialAuthService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SocialAuthService)();
    };
  }
  static {
...
var SocialLoginModule = class _SocialLoginModule {
  ...
  constructor() {
    const parentModule = inject(_SocialLoginModule, {
      optional: true,
      skipSelf: true
    });
    if (parentModule) {
  ...
  static {
    this.ɵfac = function SocialLoginModule_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SocialLoginModule)();
    };
  }
  static {
    ...
    return new Promise((resolve, reject) => {
      try {
        this.loadScript(_FacebookLoginProvider.PROVIDER_ID, `//connect.facebook.net/${this.requestOptions.locale}/sdk.js`, () => {
          ...
          this.hasError = true;
          this.onHasErrorChange.emit(this.hasError);
          reject(`There was an issue loading the ${_FacebookLoginProvider.PROVIDER_ID} authentication script.`);
        });
      } catch (err) {
        reject(err);
      } finally {
    ...
    return new Promise((resolve, reject) => {
      try {
        this.loadScript("amazon-login-sdk", "https://assets.loginwithamazon.com/sdk/na/login1.js", () => {
          ...
          this.hasError = true;
          this.onHasErrorChange.emit(this.hasError);
          reject(`There was an issue loading the ${_AmazonLoginProvider.PROVIDER_ID} authentication script.`);
        });
      } catch (err) {
        reject(err);
      } finally {
    ...
    return new Promise((resolve, reject) => {
      try {
        this.loadScript(_VKLoginProvider.PROVIDER_ID, this.VK_API_URL, () => {
          ...
          this.hasError = true;
          this.onHasErrorChange.emit(this.hasError);
          reject(`There was an issue loading the ${_VKLoginProvider.PROVIDER_ID} authentication script.`);
        });
      } catch (err) {
        reject(err);
      } finally {
    ...
    return new Promise((resolve, reject) => {
      try {
        this.loadScript(_MicrosoftLoginProvider.PROVIDER_ID, "https://alcdn.msauth.net/browser/2.13.1/js/msal-browser.min.js", () => {
          ...
          this.hasError = true;
          this.onHasErrorChange.emit(this.hasError);
          reject(`There was an issue loading the ${_MicrosoftLoginProvider.PROVIDER_ID} authentication script.`);
        });
      } catch (err) {
        reject(err);
      } finally {
...
var GoogleSigninButtonDirective = class _GoogleSigninButtonDirective {
  ...
  static {
    this.ɵfac = function GoogleSigninButtonDirective_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _GoogleSigninButtonDirective)();
    };
  }
  static {
...
var GoogleSigninButtonModule = class _GoogleSigninButtonModule {
  static {
    this.ɵfac = function GoogleSigninButtonModule_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _GoogleSigninButtonModule)();
    };
  }
  static {
    this.ɵmod = ɵɵdefineNgModule({
